   ...
   /*     long count = 0;
    	...
    	for (String time : typeCounter.keySet()) {
    		...
    		if (time.equals("2014-11-18")) {
    			...
    			result.set(2, day1_collections);
    			// 前1天加购
    			day1_carts = typeCounter.get(time)[2];
    			result.set(3, day1_carts);
    			// 前1天购买
    			day1_buys = typeCounter.get(time)[3];
    			result.set(4, day1_buys);
